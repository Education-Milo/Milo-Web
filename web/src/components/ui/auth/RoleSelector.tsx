...
export const RoleSelector: React.FC<RoleSelectorProps> = ({
  ...
  return (
    <div style={{ marginTop: '1.5rem' }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                backgroundColor: isSelected ? '#fff7ed' : (isLocked ? '#f9fafb' : 'white'),
                color: isSelected ? '#ea580c' : (isLocked ? '#9ca3af' : '#374151'),
                fontSize: '0.875rem',
                fontWeight: '500',
      ...
      {error && (
        <p className="error-message" style={{ marginTop: '0.5rem', textAlign: 'center', color: '#ef4444' }}>
          {error}
        </p>
      )}
    </div>
