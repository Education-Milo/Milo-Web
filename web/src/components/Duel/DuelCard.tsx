...
const DuelCard: React.FC<DuelCardProps> = ({
	...
	if (!duel && onRandomDuel) {
		return (
			<div
				className="duel-card random-duel"
		...
		return (
			<div className="duel-card active-duel" style={{ animationDelay }}>
				<div className="duel-header">
					<span className="duel-status">
						{duel.status === "pending" ? "En attente..." : "En cours"}
					</span>
				</div>
				<div className="duel-content">
					<div className="duel-opponent">
						<div className="opponent-avatar">{duel.opponent.firstName[0]}</div>
