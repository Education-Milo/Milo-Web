...
import type { ChapterWithLessons } from '@store/course/course.model';
            ...
            <button className="chapter-header" onClick={() => setIsOpen(!isOpen)}>
                <div className="chapter-header-left">
                    ...
                    <div className="chapter-header-title">
                        ...
                        <span className="chapter-lesson-count">{chapter.lessons.length} leçon{chapter.lessons.length > 1 ? 's' : ''}</span>
                    </div>
                </div>
