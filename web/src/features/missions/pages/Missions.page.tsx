...
const MissionsScreen: React.FC = () => {
	const { dailyMissions, monthlyChallenge, badgesByYear, sortedYears } =
		useMissionsScreen();
						...
						<section className="section-card monthly-challenge-card">
							<div className="monthly-challenge-top-content">
								...
								<div className="monthly-challenge-body">
									<p>
										Termine {monthlyChallenge.questsTotal} quêtes ce mois-ci
									...
									<div className="mission-progress-container">
										...
										<span>
											{monthlyChallenge.questsCurrent}/
											{monthlyChallenge.questsTotal}
										</span>
									</div>
								</div>
							</div>
