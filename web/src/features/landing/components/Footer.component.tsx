			...
			<div className="footer-content">
				<div className="footer-main">
					<div className="footer-brand">
						...
						/>
						<p>
							L'IA qui transforme les révisions en une aventure épique pour les
							enfants et une sérénité pour les parents.
						</p>
						<div className="footer-socials">
							...
							<a
								href="https://www.linkedin.com/company/107749290/"
								target="_blank"
								rel="noopener noreferrer"
							>
								<Linkedin size={20} />
							...
							<a
								href="https://linktr.ee/milo_education"
								target="_blank"
								rel="noopener noreferrer"
								className="linktree-pill"
							>
