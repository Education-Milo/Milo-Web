  ...
  return (
    <div className="contact-root">
      ...
      <main className="contact-main">
        ...
        <motion.div className="deco-heart" animate={{ y: [0, -20, 0] }} transition={{ duration: 4, repeat: Infinity }}>
        ...
        >
          ...
          <form className="pimped-form" onSubmit={(e) => e.preventDefault()}>
            <div className="form-row">
              <div className={`pimped-group ${focused === 'name' ? 'focused' : ''}`}>
              ...
              <div className={`pimped-group ${focused === 'email' ? 'focused' : ''}`}>
            ...
            <div className={`pimped-group ${focused === 'subject' ? 'focused' : ''}`}>
              <label><HelpCircle size={14} /> De quoi s'agit-il ?</label>
              <select onFocus={() => setFocused('subject')} onBlur={() => setFocused(null)}>
            ...
            <div className={`pimped-group ${focused === 'message' ? 'focused' : ''}`}>
              <label><MessageSquare size={14} /> Ton message</label>
              <textarea 
                rows={4} 
            ...
            >
              ...
              <div className="icon-send-circle"><Send size={18} /></div>
            </motion.button>
          </form>
        </motion.div>
      </main>
